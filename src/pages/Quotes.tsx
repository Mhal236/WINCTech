    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <h1 className="text-2xl md:text-3xl font-semibold text-[#0D9488]">Quotes</h1>
            ...
            <CardContent>
              <div className="space-y-4">
                {[1, 2, 3].map((quote) => (
                  <div
                    key={quote}
                    className="flex items-center justify-between p-4 rounded-lg border border-gray-200 hover:border-[#0D9488] transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      <ClipboardList className="h-8 w-8 text-[#0D9488]" />
                      <div>
