...
const LandingPage = () => {
  return (
    <div className="bg-white min-h-screen w-full">
      {/* Header */}
      <header className="bg-white py-6 px-6 md:px-16 w-full flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center space-x-12">
          <div className="flex items-center gap-2">
            <motion.div 
              className="h-10 w-10 bg-[#3d99be] rounded-lg flex items-center justify-center text-white"
      ...
      <section className="py-24 px-6 md:px-16 w-full">
        ...
        >
          <motion.h1 
            ...
            variants={fadeIn}
          >
            Order windscreen glass instantly with our fast software
          </motion.h1>
          <motion.p 
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="px-8 py-6 rounded-md text-lg font-medium h-auto">
                Get Started for Free
              </Button>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="outline" className="px-8 py-6 rounded-md text-lg font-medium border-gray-300 text-gray-800 h-auto">
                Contact Sales
              </Button>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeIn} whileHover={{ y: -15 }}>
            <Card className="p-8 rounded-2xl border-0 shadow-xl transition-all duration-300 h-full">
              <div className="mb-6">
                <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center">
                  <BarChart className="h-6 w-6 text-[#3d99be]" />
                </div>
              </div>
          ...
          <motion.div variants={fadeIn} whileHover={{ y: -15 }}>
            <Card className="p-8 rounded-2xl border-0 shadow-xl transition-all duration-300 h-full">
              <div className="mb-6">
                <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center">
                  <Clock className="h-6 w-6 text-[#3d99be]" />
                </div>
              </div>
      ...
      <section className="py-24 px-6 md:px-16 w-full bg-gray-50">
        ...
        >
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <motion.div 
              ...
              variants={fadeIn} 
              whileHover={{ y: -10 }}
              className={`bg-white p-8 rounded-2xl shadow-lg ${i > 3 ? 'hidden md:block' : ''}`}
            >
              ...
              <div className="flex items-center">
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="h-5 w-5 text-[#3d99be]" fill="#3d99be" />
                  ))}
                </div>
        ...
        >
          <div className="text-center">
            <h3 className="text-4xl font-bold text-[#3d99be] mb-2">100<span className="text-lg align-top">k+</span></h3>
            <p className="text-gray-600">Happy users</p>
          </div>
          <div className="text-center">
            <h3 className="text-4xl font-bold text-[#3d99be] mb-2">250<span className="text-lg align-top">k+</span></h3>
            <p className="text-gray-600">Total hrs saved</p>
          </div>
          <div className="text-center">
            <h3 className="text-4xl font-bold text-[#3d99be] mb-2">4.8</h3>
      ...
      <section className="py-24 px-6 md:px-16 w-full bg-gray-50">
        ...
        >
          <motion.h2 
            ...
            variants={fadeIn}
          >
            Connect with all of your favourite apps
          </motion.h2>
          <motion.p
      ...
      <section className="py-24 px-6 md:px-16 w-full">
        ...
        >
          ...
          <span className="text-sm bg-blue-100 text-[#135084] px-3 py-1 rounded-full font-medium">30% off</span>
        </motion.div>
        ...
        >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#3d99be] flex-shrink-0" />
          ...
          <motion.div variants={fadeIn} whileHover={{ y: -10 }}>
            <Card className="p-8 rounded-2xl border-0 shadow-2xl transition-all duration-300 relative overflow-hidden scale-105 z-10">
              <div className="absolute -top-1 right-0 bg-[#3d99be] text-white px-6 py-2 font-medium rotate-0 rounded-b-lg shadow-lg">
                Popular
              </div>
              <div className="mb-4">
      ...
      <section className="py-24 px-6 md:px-16 w-full">
        <motion.div 
          className="bg-gray-50 rounded-3xl p-12 text-center max-w-[1200px] mx-auto shadow-lg"
      ...
      {/* Footer */}
      <footer className="bg-white py-16 px-6 md:px-16 w-full border-t border-gray-100">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <div className="flex items-center space-x-2 mb-8 md:mb-0">
              <span className="h-10 w-10 rounded-lg bg-[#3d99be] flex items-center justify-center text-white font-bold">
                <ShoppingCart className="h-6 w-6" />
              </span>
              <span className="font-semibold text-xl">WindscreenCompare</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-500 hover:text-gray-900">Testimonials</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-500 hover:text-gray-900">Sales</a></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 hover:text-gray-900">Job Openings</a></li>
                <li><a href="#" className="text-gray-500 hover:text-gray-900">Benefits</a></li>
                <li><a href="#" className="text-gray-500 hover:text-gray-900">Our Team</a></li>
              </ul>
            </div>
          </div>
